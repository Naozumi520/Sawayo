...
module.exports.run = async (bot, message, args) => {
    ...
    if(!tobemute) return message.reply("> <:error:759791498279125042> I can't found this user."); //If user not found then it will send "I can't found this user."
    if(tobemute.hasPermission("MANAGE_MESSAGES")) return message.reply("> <:error:759791498279125042> Can't mute this user."); //If the role has MANAGE_MESSAGE then the bot can't mute the user.
...
let mutetime = args[1];
if (!mutetime) return message.reply("> <:error:759791498279125042> You didn't specify a time"); // Time has not been entered.
